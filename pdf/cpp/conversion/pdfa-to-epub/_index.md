---
title: Convert PDFA to EPUB via C++ application 
url: /cpp/conversion/pdfa-to-epub/ 
description: Sample C++ conversion code for PDFA document to EPUB format. Programmers can use this source code for batch PDFA to EPUB conversion within any C++ application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDFA to EPUB via C++" h2="High performance PDFA to EPUB conversion using C++ library without any other software dependency." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EPUB" pfName="Aspose.PDF" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDFA" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDFA to EPUB Using C++" %}}

 In order to convert PDFA to EPUB, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDFA to EPUB via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="PDFA to EPUB C++ Conversion Source Code" offSpacer="" %}}
