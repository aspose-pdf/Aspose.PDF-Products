...
description: Sample C++ conversion code for PDF document to GIF format. Programmers can use this source code for batch PDF to GIF conversion within any C++ application.
---
