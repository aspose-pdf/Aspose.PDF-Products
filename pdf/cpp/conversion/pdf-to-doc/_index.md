...
{{< blocks/products/pf/agp/faq imgSrc="https://www.aspose.com/templates/brand/images/pdf/aspose_pdf-brand.png" >}}
    ...
    {{< blocks/products/pf/agp/faq-item question="Can I convert PDF to DOC via Java or .NET?" answer="Aspose.PDF is available for all major programming environments. Checkout [Java](https://products.aspose.com/pdf/java/conversion/pdf-to-doc) and [.NET](https://products.aspose.com/pdf/net/conversion/pdf-to-doc) source code snippets for PDF to DOC conversion." >}}
    {{< blocks/products/pf/agp/faq-item question="Can I convert PDF to DOC on other platforms?" answer="You can execute the code with C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit." >}}
