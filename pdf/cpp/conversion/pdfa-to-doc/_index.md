---
title: Convert PDFA to DOC via C++ application 
weight: 1490
url: /cpp/conversion/pdfa-to-doc/ 
description: Sample C++ conversion code for PDFA document to DOC format. Programmers can use this source code for batch PDFA to DOC conversion within any C++ application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDFA to DOC via C++" h2="High performance PDFA to DOC conversion using C++ library without any other software dependency." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.PDF" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDFA" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDFA to DOC Using C++" %}}

 In order to convert PDFA to DOC, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDFA to DOC via C++" %}}
