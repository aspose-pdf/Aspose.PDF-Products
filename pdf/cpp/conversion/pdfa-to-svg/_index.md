---
title: Convert PDFA to SVG via C++ application 
weight: 480
url: /cpp/conversion/pdfa-to-svg/ 
description: Sample C++ conversion code for PDFA document to SVG format. Programmers can use this source code for batch PDFA to SVG conversion within any C++ application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDFA to SVG via C++" h2="High performance PDFA to SVG conversion using C++ library without any other software dependency." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.PDF" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDFA" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDFA to SVG Using C++" %}}

 In order to convert PDFA to SVG, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDFA to SVG via C++" %}}
