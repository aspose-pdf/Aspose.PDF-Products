...
description: Sample C++ conversion code for XML document to JPEG format. Programmers can use this source code for batch XML to JPEG conversion within any C++ application.
---
