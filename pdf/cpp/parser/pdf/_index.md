...
weight: 310
url: /cpp/parser/pdf/ 
description: Try our On-Premise document parser APIs to extract text and images from PDF file on C++ Runtime Environment for Windows 32 bit, Windows 64 bit and Linux 64 bit.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Parse PDF FormatsВ in C++" h2="Native and high performance PDF documentВ parsing using server-side Aspose.PDF for C++ APIs, without the use of any software like Microsoft or Adobe PDF." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/pdf/272x272/aspose_pdf-for-cpp.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.PDF" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Parse PDF File Using C++" %}}
 ...
 In order to parse PDF file, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Parse PDF Files in C++" %}}
...
+  Instantiate PdfExtractor class object.
+  Use BindPdf() method to load PDF.
+  Use ExtractText() method to extract the text
...
{{% blocks/products/pf/agp/code-block title="ParseВ PDF Files - C++" offSpacer="" %}}

```cs
auto extractor = MakeObject<Facades::PdfExtractor>();
// Bind source PDF document
extractor->BindPdf(u"sourceFile.pdf");
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online PDF Parser Live Demos" sectionDescription="Extract text and images fromВ PDF documents right now by visiting our [Live Demos website](https://products.aspose.app/pdf/parser). The live demo has the following benefits" >}}
