...
{{% blocks/products/pf/agp/code-block title="Parse PDF Files - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online PDF Parser Live Demos" sectionDescription="Extract text and images from PDF documents right now by visiting our [Live Demos website](https://products.aspose.app/pdf/parser). The live demo has the following benefits" >}}
