...
{{< blocks/products/pf/upper-banner h1="Extract PDF Metadata via Java" h2="Build your own Java apps to add, edit, remove or extract metadata from PDF files using server-side APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/pdf/272x272/aspose_pdf-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.PDF" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/pdf/java" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Extract Metadata of PDF via Java" %}}
...
+  Get DocumentInfo using getInfo()
...
{{% blocks/products/pf/agp/code-block title="Extract Metadata of PDF - Java" offSpacer="" %}}
