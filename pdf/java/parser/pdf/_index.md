...
{{% blocks/products/pf/agp/content h2="How to Parse PDF File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Parse PDF Files in Java" %}}
...
+  Instantiate TextAbsorber class
+  Accept the absorber for all the pages
+  Get the extracted text;
+  Wrtie the extracted text to txt file
...
{{% blocks/products/pf/agp/code-block title="Parse PDF Files - Java" offSpacer="" %}}
