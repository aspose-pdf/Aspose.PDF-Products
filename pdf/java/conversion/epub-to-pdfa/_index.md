...
{{% blocks/products/pf/agp/content h2="How to Convert EPUB to PDFA Using Java" %}}

 In order to render EPUB to PDFA, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert EPUB to PDFA via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert EPUB file to PDFA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="EPUB to PDFA Java Conversion Source Code" offSpacer="" %}}
