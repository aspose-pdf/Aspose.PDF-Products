...
description: Sample Java conversion code for MHTML format to DOCX file. Programmers can use this example code to export MHTML to DOCX within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHTML to DOCX via Java" h2="Read, Write and Convert MHTML to DOCX using native Java library without needing Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.PDF" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to DOCX Using Java" %}}
 ...
 In order to render MHTML to DOCX, we’ll use
...
{{% blocks/products/pf/agp/code-block title="MHTML to DOCX Java Conversion Source Code" offSpacer="" %}}
