...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert XML file to PDFA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XML to PDFA Java Conversion Source Code" offSpacer="" %}}
