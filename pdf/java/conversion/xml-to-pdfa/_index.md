...
{{% blocks/products/pf/agp/content h2="How to Convert XML to PDFA Using Java" %}}
 ...
 In order to render XML to PDFA, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XML to PDFA via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Convert XML to PDFA - JavaвЂЋ" offSpacer="" %}}
