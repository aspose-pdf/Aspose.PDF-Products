---
title: Convert PDF to Microsoft PowerPoint PPTX via Java 
url: /java/conversion/pdf-to-pptx/ 
description: Sample Java conversion for PDF format to PPTX file. Programmers can use this example code to export PDF to PPTX PowerPoint within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to PPTX via Java" h2="Read, Write and Convert PDF to Microsoft PowerPoint PPTX presentation using native Java library without needing Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to PPTX Presentation Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to PowerPoint PPTX File via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert PDF file to PPTX in just a few lines of code.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before running the **Java PDF to PowerPoint conversion** example code, make sure that you have the following prerequisites.
