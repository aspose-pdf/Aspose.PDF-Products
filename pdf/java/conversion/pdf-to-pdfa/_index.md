...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to PDFA Using Java" %}}

 In order to render PDF to PDFA, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to PDFA via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert PDF file to PDFA in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="PDF to PDFA Java Conversion Source Code" offSpacer="" %}}
