...
{{< blocks/products/pf/upper-banner h1="Convert PS to DOCX via Java" h2="Native Java Library to Read, Write & Export PS to DOCX without needing Adobe." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/pdf/272x272/aspose_pdf-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.PDF" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PS" >}}
...
{{% blocks/products/pf/agp/code-block title="Convert PS to DOCX - Java‎" offSpacer="" %}}
