---
title: Convert PDF to DOCX Microsoft Word via Java 
url: /java/conversion/pdf-to-docx/ 
description: Sample Java conversion code for PDF format to DOCX file. Programmers can use this example code to export PDF to Microsoft Word DOCX within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to DOCX via Java" h2="Read, Write and Convert PDF to Microsoft Word DOCX files using native Java library without needing Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to DOCX Using Java" %}}

 In order to render PDF to Microsoft Word DOCX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert PDF file to DOCX in just a few lines of code.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before running the **Java PDF to Microsoft Word DOCX conversion** example code, make sure that you have the following prerequisites.
...
{{% blocks/products/pf/agp/code-block title="PDF to DOCX Java Conversion Source Code" offSpacer="" %}}
