---
title: Convert PDF to DOCX via Java 
url: /java/conversion/pdf-to-docx/ 
description: Sample Java conversion code for PDF format to DOCX file. Programmers can use this example code to export PDF to DOCX within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to DOCX via Java" h2="Read, Write and Convert PDF to DOCX using native Java library without needing Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.PDF" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to DOCX Using Java" %}}
 ...
 In order to render PDF to DOCX, we’ll use
