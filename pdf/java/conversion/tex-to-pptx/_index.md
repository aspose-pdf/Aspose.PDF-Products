...
description: Sample Java conversion code for TEX format to PPTX file. Programmers can use this example code to export TEX to PPTX within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TEX to PPTX via Java" h2="Read, Write and Convert TEX to PPTX using native Java library without needing Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.PDF" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TEX" >}}
...
{{% blocks/products/pf/agp/code-block title="TEX to PPTX Java Conversion Source Code" offSpacer="" %}}
