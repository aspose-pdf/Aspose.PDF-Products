---
title: Search and replace text in PDF document via Java
weight: 770
url: /java/redaction/pdf/
description: Java sample code to redact sensitive information in PDF file on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Redact PDF Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Redact PDF Files - Java" offSpacer="" %}}
