---
title: Convert XSLFO to PPTX via C# 
url: /net/conversion/xslfo-to-pptx/ 
description: Sample code for XSLFO to PPTX C# conversion. Use API example code for batch XSLFO files to PPTX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XSLFO to PPTX via C#" h2="Export XSLFO documents to multiple formats including PPTX on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XSLFO" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XSLFO to PPTX Using C#" %}}

 In order to convert XSLFO to PPTX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XSLFO to PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert XSLFO files to PPTX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XSLFO to PPTX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XSLFO to PPTX" sectionDescription="Check our live demos for [XSLFO to PPTX conversion](https://products.aspose.app/pdf/conversion/xslfo-to-pptx) with following benefits." >}}
