---
title: Convert PDF to XML via C# 
weight: 60
url: /net/conversion/pdf-to-xml/ 
description: Sample code for PDF to XML C# conversion. Use API example code for batch PDF files to XML conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert PDF files to XML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to XML C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PDF to XML" sectionDescription="Check our live demos for [PDF to XML conversion](https://products.aspose.app/pdf/conversion/pdf-to-xml) with following benefits." >}}
