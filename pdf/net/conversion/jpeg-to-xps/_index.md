---
title: Convert JPEG to XPS via C#
url: /net/conversion/jpeg-to-xps/
description: Sample code for JPEG to XPS C# conversion. Use API example code for batch JPEG files to XPS conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert JPEG to XPS via C#" h2="Export JPEG documents to multiple formats including XPS on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert JPEG to XPS Using C#" %}}

 In order to convert JPEG to XPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert JPEG to XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert JPEG files to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows JPEG to XPS C# Conversion" offSpacer="" %}}

```cs
public static void ConvertJPGtoXPS()
    {
    // Load input PNG file
    ...
    // Save output PDF
    document.Save(_dataDir + "JPEGtoXPS.xps", SaveFormat.Xps);
    }
```
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert JPEG to XPS" sectionDescription="Check our live demos for [JPEG to XPS conversion](https://products.aspose.app/pdf/conversion/jpg) with following benefits." >}}
