---
title: Convert XSLFO to EMF via C# 
url: /net/conversion/xslfo-to-emf/ 
description: Sample code for XSLFO to EMF C# conversion. Use API example code for batch XSLFO files to EMF conversion within VB.NET, Asp.NET or any .NET based application.
---
