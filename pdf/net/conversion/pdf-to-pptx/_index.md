---
title: Convert PDF to Microsoft PowerPoint PPTX File via C#
weight: 1380
url: /net/conversion/pdf-to-pptx/
description: Sample code for PDF to PPTX C# conversion. Use API example code for batch PDF to Microsoft PowerPoint PPTX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to PPTX via C#" h2="Export PDF documents to multiple Microsoft PowerPoint formats including PPTX Using .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to Microsoft PowerPoint PPTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert PDF files to PPTX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to PPTX C# Conversion" offSpacer="" %}}
