---
title: Convert PDF to Microsoft Excel XLSX via C# 
weight: 2930
url: /net/conversion/pdf-to-xlsx/ 
description: Sample code for PDF to XLSX C# conversion. Use API example code for batch PDF to Microsoft Excel XLSX files conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to XLSX via C#" h2="Export PDF files to multiple Microsoft Excel formats including XLSX Using .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to Microsoft Excel XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert PDF files to XLSX in just a few lines of code.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before running the **PDF to Microsoft Excel .NET conversion** sample code, make sure that you have the following prerequisites.
