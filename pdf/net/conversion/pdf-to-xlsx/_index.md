---
title: Convert PDF to XLSX via C# 
weight: 2930
url: /net/conversion/pdf-to-xlsx/ 
description: Sample code for PDF to XLSX C# conversion. Use API example code for batch PDF files to XLSX conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert PDF files to XLSX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to XLSX C# Conversion" offSpacer="" %}}
