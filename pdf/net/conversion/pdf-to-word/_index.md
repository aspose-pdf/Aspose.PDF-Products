...
{{< blocks/products/pf/upper-banner h1="Convert PDF to Word via .NET" h2="Export PDF to Microsoft Word DOC & DOCX document formats via .NET library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="C# Code for PDF to DOC Conversion" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="DOC" fileiconsmall3="DOCX" fileiconsmall4="TEX" fileiconsmall5="Pdf" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET PDF Library provides the ability to generate, modify, convert, render, secure and print PDF documents. It also offers compression, table creation, graph & image functions, hyperlinks, stamp and watermarking, security controls & font handling. One of the major features is to **convert PDF to Microsoft Word** DOC & DOCX formats.
