---
title: Convert MHT to MHTML via C# 
url: /net/conversion/mht-to-mhtml/ 
description: Sample code for MHT to MHTML C# conversion. Use API example code for batch MHT files to MHTML conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHT to MHTML via C#" h2="Export MHT documents to multiple formats including MHTML on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MHT to MHTML Using C#" %}}

 In order to convert MHT to MHTML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MHT to MHTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert MHT files to MHTML in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Load MHT file with an instance of Document
1. Call the Document.Save method while passing the output file path & SaveFormat.Mhtml as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MHT to MHTML C# Conversion" offSpacer="" %}}

```cs
// load MHT with an instance of Document
var document = new Aspose.Pdf.Document("template.mht");
// save document in MHTML format
document.Save("output.mhtml", Aspose.Pdf.SaveFormat.Mhtml); 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MHT to MHTML" sectionDescription="Check our live demos for [MHT to MHTML conversion](https://products.aspose.app/pdf/conversion/mht-to-mhtml) with following benefits." >}}
