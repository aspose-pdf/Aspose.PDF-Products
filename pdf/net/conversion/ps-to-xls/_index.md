---
title: Convert PS to XLS via C# 
weight: 330
url: /net/conversion/ps-to-xls/ 
description: Sample code for PS to XLS C# conversion. Use API example code for batch PS files to XLS conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert PS to XLS Using C#" %}}

 In order to convert PS to XLS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PS to XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert PS files to XLS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PS to XLS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PS to XLS" sectionDescription="Check our live demos for [PS to XLS conversion](https://products.aspose.app/pdf/conversion/ps-to-xls) with following benefits." >}}
