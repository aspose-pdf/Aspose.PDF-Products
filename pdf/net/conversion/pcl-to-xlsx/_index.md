---
title: Convert PCL to XLSX via C# 
weight: 1060
url: /net/conversion/pcl-to-xlsx/ 
description: Sample code for PCL to XLSX C# conversion. Use API example code for batch PCL files to XLSX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PCL to XLSX via C#" h2="Export PCL documents to multiple formats including XLSX on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PCL" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PCL to XLSX Using C#" %}}

 In order to convert PCL to XLSX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PCL to XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert PCL files to XLSX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PCL to XLSX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PCL to XLSX" sectionDescription="Check our live demos for [PCL to XLSX conversion](https://products.aspose.app/pdf/conversion/pcl-to-xlsx) with following benefits." >}}
