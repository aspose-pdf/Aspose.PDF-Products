---
title: Convert PS to TIFF via C# 
weight: 30
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert PS files to TIFF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PS to TIFF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PS to TIFF" sectionDescription="Check our live demos for [PS to TIFF conversion](https://products.aspose.app/pdf/conversion/ps-to-tiff) with following benefits." >}}
