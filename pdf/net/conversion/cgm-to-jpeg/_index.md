---
title: Convert CGM to JPEG via .NET 
...
{{% blocks/products/pf/agp/content h2="How to Convert CGM to JPEG Using C#" %}}
 ...
 In order to convert CGM to JPEG, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert CGM files to JPEG in just a few lines of code.
