---
title: Convert PS to DOCX via C# 
weight: 2700
url: /net/conversion/ps-to-docx/ 
description: Sample code for PS to DOCX C# conversion. Use API example code for batch PS files to DOCX conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PS to DOCX C# Conversion" offSpacer="" %}}
