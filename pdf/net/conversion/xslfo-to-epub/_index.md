---
title: Convert XSLFO to EPUB via .NET 
...
{{< blocks/products/pf/upper-banner h1="Convert XSLFO to EPUB via C#" h2="Export XSLFO documents to multiple formats including EPUB on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/pdf/272x272/aspose_pdf-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="EPUB" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XSLFO" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XSLFO to EPUB via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert XSLFO files to EPUB in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XSLFO to EPUB" sectionDescription="Check our live demos for [XSLFO to EPUB conversion](https://products.aspose.app/pdf/conversion/xslfo-to-epub) with following benefits." >}}
