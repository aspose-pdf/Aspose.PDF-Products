---
title: Convert PDF to HTML via C# 
weight: 2240
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert PDF files to HTML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to HTML C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PDF to HTML" sectionDescription="Check our live demos for [PDF to HTML conversion](https://products.aspose.app/pdf/conversion/pdf-to-html) with following benefits." >}}
