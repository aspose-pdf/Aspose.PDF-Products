...
{{< blocks/products/pf/upper-banner h1="Convert PDF to HTML via C#" h2="Export PDF documents to multiple formats including HTML Using .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load and convert PDF files to HTML in just a few lines of code.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before running the **PDF to HTML C# conversion** example source code, make sure that you have the following prerequisites.
