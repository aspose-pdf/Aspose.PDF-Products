---
title: Convert SVG to XML via C# 
url: /net/conversion/svg-to-xml/ 
description: Sample code for SVG to XML C# conversion. Use API example code for batch SVG files to XML conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows SVG to XML C# Conversion" offSpacer="" %}}
