---
title: Convert XSLFO to DOCX via C# 
url: /net/conversion/xslfo-to-docx/ 
description: Sample code for XSLFO to DOCX C# conversion. Use API example code for batch XSLFO files to DOCX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XSLFO to DOCX via C#" h2="Export XSLFO documents to multiple formats including DOCX on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XSLFO" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XSLFO to DOCX C# Conversion" offSpacer="" %}}
