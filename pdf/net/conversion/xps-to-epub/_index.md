---
title: Convert XPS to EPUB via C# 
url: /net/conversion/xps-to-epub/ 
description: Sample code for XPS to EPUB C# conversion. Use API example code for batch XPS files to EPUB conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XPS to EPUB via C#" h2="Export XPS documents to multiple formats including EPUB on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EPUB" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XPS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XPS to EPUB Using C#" %}}

 In order to convert XPS to EPUB, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XPS to EPUB via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert XPS files to EPUB in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XPS to EPUB C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XPS to EPUB" sectionDescription="Check our live demos for [XPS to EPUB conversion](https://products.aspose.app/pdf/conversion/xps-to-epub) with following benefits." >}}
