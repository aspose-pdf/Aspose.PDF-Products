---
title: Convert MD to XLSX via C# 
weight: 1160
url: /net/conversion/md-to-xlsx/ 
description: Sample code for MD to XLSX C# conversion. Use API example code for batch MD files to XLSX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MD to XLSX via C#" h2="Export MD documents to multiple formats including XLSX on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MD" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert MD files to XLSX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MD to XLSX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MD to XLSX" sectionDescription="Check our live demos for [MD to XLSX conversion](https://products.aspose.app/pdf/conversion/md-to-xlsx) with following benefits." >}}
