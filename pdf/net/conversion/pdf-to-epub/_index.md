---
title: Convert PDF to EPUB via C# 
weight: 990
url: /net/conversion/pdf-to-epub/ 
description: Sample code for PDF to EPUB C# conversion. Use API example code for batch PDF files to EPUB conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert PDF files to EPUB in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to EPUB C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PDF to EPUB" sectionDescription="Check our live demos for [PDF to EPUB conversion](https://products.aspose.app/pdf/conversion/pdf-to-epub) with following benefits." >}}
