---
title: Convert PS to DOC via C# 
weight: 950
url: /net/conversion/ps-to-doc/ 
description: Sample code for PS to DOC C# conversion. Use API example code for batch PS files to DOC conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PS to DOC C# Conversion" offSpacer="" %}}
