...
description: Sample code for PDF to DOC C# conversion. Use API example code for batch PDF files to Microsoft Word DOC conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to DOC via C#" h2="Export PDF documents to multiple Microsoft Word formats including DOC Using .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
Before implementing **PDF to Word DOC C# Conversion** source code, Just make sure that you have the following prerequisites.
