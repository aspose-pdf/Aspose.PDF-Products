---
title: Convert HTML to SVG via C# 
url: /net/conversion/html-to-svg/ 
description: Sample code for HTML to SVG C# conversion. Use API example code for batch HTML files to SVG conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert HTML to SVG via C#" h2="Export HTML documents to multiple formats including SVG on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert HTML files to SVG in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows HTML to SVG C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert HTML to SVG" sectionDescription="Check our live demos for [HTML to SVG conversion](https://products.aspose.app/pdf/conversion/html-to-svg) with following benefits." >}}
