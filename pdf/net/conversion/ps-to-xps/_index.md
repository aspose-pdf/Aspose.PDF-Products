---
title: Convert PS to XPS via C# 
weight: 1340
url: /net/conversion/ps-to-xps/ 
description: Sample code for PS to XPS C# conversion. Use API example code for batch PS files to XPS conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert PS to XPS Using C#" %}}

 In order to convert PS to XPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PS to XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert PS files to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PS to XPS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PS to XPS" sectionDescription="Check our live demos for [PS to XPS conversion](https://products.aspose.app/pdf/conversion/ps-to-xps) with following benefits." >}}
