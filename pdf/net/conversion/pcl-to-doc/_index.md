---
title: Convert PCL to DOC via C# 
weight: 1000
url: /net/conversion/pcl-to-doc/ 
description: Sample code for PCL to DOC C# conversion. Use API example code for batch PCL files to DOC conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PCL to DOC via C#" h2="Export PCL documents to multiple formats including DOC on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PCL" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert PCL files to DOC in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PCL to DOC C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PCL to DOC" sectionDescription="Check our live demos for [PCL to DOC conversion](https://products.aspose.app/pdf/conversion/pcl-to-doc) with following benefits." >}}
