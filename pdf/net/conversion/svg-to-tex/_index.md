---
title: Convert SVG to TEX via C# 
url: /net/conversion/svg-to-tex/ 
description: Sample code for SVG to TEX C# conversion. Use API example code for batch SVG files to TEX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SVG to TEX via C#" h2="Export SVG documents to multiple formats including TEX on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TEX" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SVG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert SVG to TEX Using C#" %}}

 In order to convert SVG to TEX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert SVG to TEX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert SVG files to TEX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows SVG to TEX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SVG to TEX" sectionDescription="Check our live demos for [SVG to TEX conversion](https://products.aspose.app/pdf/conversion/svg-to-tex) with following benefits." >}}
