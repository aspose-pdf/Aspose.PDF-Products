...
description: Sample code for JPEG to DOCX C# conversion. Use API example code for batch JPEG files to DOCX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert JPEG to DOCX via C#" h2="Export JPEG documents to multiple formats including DOCX on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert JPEG to DOCX Using C#" %}}

 In order to convert JPEG to DOCX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert JPEG to DOCX via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows JPEG to DOCX C# Conversion" offSpacer="" %}}

```cs
public static void ConvertJPGtoDOCX()
    {
    // Load input PNG file
    ...
    // Save output PDF
    document.Save(_dataDir + "JPEGtoPPTX.pdf", SaveFormat.DocX);
    }
```
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert JPEG to DOCX" sectionDescription="Check our live demos for [JPEG to DOCX conversion](https://products.aspose.app/pdf/conversion/jpg-to-docx) with following benefits." >}}
