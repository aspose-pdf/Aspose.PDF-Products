---
title: Convert MHT to DOCX via C# 
url: /net/conversion/mht-to-docx/ 
description: Sample code for MHT to DOCX C# conversion. Use API example code for batch MHT files to DOCX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHT to DOCX via C#" h2="Export MHT documents to multiple formats including DOCX on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MHT to DOCX C# Conversion" offSpacer="" %}}
