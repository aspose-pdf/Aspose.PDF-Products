---
title: Convert CGM to SVG via .NET 
...
{{< blocks/products/pf/upper-banner h1="Convert CGM to SVG via C#" h2="Export CGM documents to multiple formats including SVG on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/pdf/272x272/aspose_pdf-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CGM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert CGM to SVG Using C#" %}}
 ...
 In order to convert CGM to SVG, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert CGM files to SVG in just a few lines of code.
