---
title: Convert PDF to TEX via C# 
weight: 1820
url: /net/conversion/pdf-to-tex/ 
description: Sample code for PDF to TEX C# conversion. Use API example code for batch PDF files to TEX conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert PDF files to TEX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to TEX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PDF to TEX" sectionDescription="Check our live demos for [PDF to TEX conversion](https://products.aspose.app/pdf/conversion/pdf-to-tex) with following benefits." >}}
