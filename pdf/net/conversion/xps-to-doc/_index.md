---
title: Convert XPS to DOC via C# 
url: /net/conversion/xps-to-doc/ 
description: Sample code for XPS to DOC C# conversion. Use API example code for batch XPS files to DOC conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XPS to DOC via C#" h2="Export XPS documents to multiple formats including DOC on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.PDF" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XPS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XPS to DOC Using C#" %}}

 In order to convert XPS to DOC, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XPS to DOC via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PDF makes it easy for the developers to load & convert XPS files to DOC in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows XPS to DOC C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XPS to DOC" sectionDescription="Check our live demos for [XPS to DOC conversion](https://products.aspose.app/pdf/conversion/xps-to-doc) with following benefits." >}}
