---
title: Convert PDF to DOCX via C# 
weight: 620
url: /net/conversion/pdf-to-docx/ 
description: Sample code for PDF to DOCX C# conversion. Use API example code for batch PDF files to DOCX conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PDF makes it easy for the developers to load & convert PDF files to DOCX in just a few lines of code.
