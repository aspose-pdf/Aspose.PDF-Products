---
title: Convert PDF to Microsoft Word DOCX via C#
weight: 620
url: /net/conversion/pdf-to-docx/
description: Sample code for PDF to DOCX C# conversion. Use API example code for batch PDF to Micorsoft Word DOCX files conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to DOCX via C#" h2="Export PDF documents to multiple Microsoft Word formats including DOCX Using .NET APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/pdf/aspose_pdf-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to Microsoft Word DOCX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert PDF files to DOCX in just a few lines of code.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Before running the **PDF to Microsoft Word DOCX conversion** sample code, make sure that you have the following prerequisites.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PDF to DOCX C# Conversion" offSpacer="" %}}
