...
url: /net/viewer/epub/
description: C# source code to load, render and display EPUB documents on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/code-block title="C# example code to view EPUB file" offSpacer="" %}}
...
Aspose.PDF API can be used for PDF document manipulation and parsing within applications. One can create, modify, compress, secure, print or save PDF to TXT, HTML, PCL, XFA, XML, XPS, EPUB, TEX, Images and more formats. Aspose.PDF is a standalone API and it does not depend on any software including Adobe Acrobat.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Free App to View EPUB" sectionDescription="Check our live demos to [View EPUB](https://products.aspose.app/pdf/viewer/epub) with following benefits." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Instantly View the EPUB file" >}}
