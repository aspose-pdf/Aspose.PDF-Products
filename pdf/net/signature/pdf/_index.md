...
{{% blocks/products/pf/agp/content h2="How to Digitally Sign PDF File Using C#" %}}
 ...
 In order to electronically sign PDF file, weвЂ™ll use
...
+  SaveВ PDF file, You will get the document with signature inserted.
...
```cs
var doc = new Aspose.Pdf.Document("My File.pdf");
...
doc.Save("Saved File.pdf", Aspose.Pdf.SaveFormat.Pdf);  
