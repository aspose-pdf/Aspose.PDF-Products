...
weight: 2790
url: /net/merger/pcl/ 
description: Try our On-Premise document merger APIs to combine PCL documents on .NET Framework, .NET Core, and PHP, VBScript, Delphi, C++ via COM Interop.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge PCL File Using C#" %}}
 ...
 In order to merge PCL file, weвЂ™ll use
